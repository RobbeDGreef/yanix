...
typedef ssize_t			(*fs_read_file_fpointer)  (ino_t inode, unsigned int offset, void *buf, size_t count, filesystem_t *fs_info);
typedef ssize_t 		(*fs_write_file_fpointer) (ino_t inode, unsigned int offset, const void *buf, size_t count, filesystem_t *fs_info);
