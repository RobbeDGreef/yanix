...
void abort(void) __attribute__((__noreturn__));		// causes an abnormal program termination
void exit(int status) __attribute__((__noreturn__));// causes a program to terminate normally
