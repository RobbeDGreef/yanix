...
struct ll_node
{
	size_t	size;			/* The size of this block (without the size of the this node added to it) */
...
struct linkedlist
{
	...
	size_t			cursize;	/* The current size of the heap in bytes (end address = start address + cursize) */
	int 			user;
