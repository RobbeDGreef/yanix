...
inline void __attribute__((always_inline)) dump_stacktrace()
{
	...
	debug_print("~ "); debug_print_hex((int) get_return_address(8)); debug_print("\n");
	debug_print("~ "); debug_print_hex((int) get_return_address(9)); debug_print("\n");
	debug_print("~ "); debug_print_hex((int) get_return_address(10)); debug_print("\n");
	debug_print("~ "); debug_print_hex((int) get_return_address(11)); debug_print("\n");	
}
...
void print_stack()
{
	...
	debug_print("Stack: "); debug_print_hex(stack); debug_print("\n");
}
